...
var (
	...
	ErrOldPassword       = errors.New("this user requires old password authentication. If you still want to use it, please add 'allowOldPasswords=1' to your DSN. See also https://github.com/mariadb-corporation/mariadb-connector-go/wiki/old_passwords")
	...
	// See https://github.com/mariadb-corporation/mariadb-connector-go/pull/302
